...
<title>LASTOUT — liquidation coverage on Robinhood Chain</title>
...
<header>
  <div>
    ...
    <div class="tag-line">Liquidation coverage on Robinhood Chain. Don't be last out.</div>
  </div>
  <div class="stamp">
...
python3 probe/redemption.py   # local redemption paths</pre>
  ...
  <code>data/</code> daily. Source: <a href="https://github.com/lastoutlabs/lastout-x402">github.com/lastoutlabs/lastout-x402</a></p>
</section>
